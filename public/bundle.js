...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dashboard = __webpack_require__(6);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var firebaseUtils = __webpack_require__(31);
	...
	var Main = React.createClass({displayName: "Main",
		...
		render: function() {
			...
			if(this.state.loggedIn) {
				loginOrOut = React.createElement("li", null, React.createElement(Link, {to: "logout", className: "navbar-brand navbar-link"}, " Logout "));
				register = null
			}
			else {
				loginOrOut = React.createElement("li", null, " ", React.createElement(Link, {to: "login", className: "navbar-brand navbar-link"}, " Login "));
				register = React.createElement("li", null, " ", React.createElement(Link, {to: "register", className: "navbar-brand navbar-link"}, " Register "), " ");
			}
			return (
				React.createElement("span", null, 
					React.createElement("nav", {className: "navbar navbar-default navbar-static-top navbar-height"}, 
						React.createElement("div", {className: "container-fluid"}, 
							React.createElement("div", {className: "navbar-header"}, 
								React.createElement(Link, {to: "home", className: "navbar-brand navbar-title"}, " Sole Renewal ")
							), 
							React.createElement("ul", {className: "nav navbar-nav pull-right"}, 
								React.createElement("li", null, React.createElement(Link, {to: "dashboard", className: "navbar-brand navbar-link"}, " Dashboard ")), 
								register, 
								loginOrOut
							)
							)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dashboard = React.createClass({displayName: "Dashboard",
		render: function(){
			return (
				React.createElement("p", null, " This is the Dashboard & SHOULD be protected!! ")
			)
		}
	});	
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var Configuration = __webpack_require__(58);
